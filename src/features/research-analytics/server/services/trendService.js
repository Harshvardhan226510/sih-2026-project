...
import { mean, sum, linearRegression, movingAverage, coefficientOfVariation, calculateAnomalyPercentage } from '../utils/statistics.js';
export class TrendService {
    ...
    async getTrendAnalytics(location, startDate, endDate, metric = 'rainfall') {
        ...
        const seasonalBreakdown = ['Summer', 'Monsoon', 'Post-Monsoon', 'Winter'].map(season => {
