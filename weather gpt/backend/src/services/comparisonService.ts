...
export class ComparisonService {
  ...
  private computeSummary(values: number[], metric: WeatherMetric): StatisticalSummary {
  ...
  async compareLocations(
    locA: LocationCoordinates,
    locB: LocationCoordinates,
    startDate: string,
    endDate: string,
    ...
    const timeSeries: Array<{ date: string; valueA: number; valueB: number; diff: number }> = [];
